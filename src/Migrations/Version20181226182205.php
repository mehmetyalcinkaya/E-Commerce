 ...
 */
final class Version20181226182205 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD address VARCHAR(150) DEFAULT NULL, ADD city VARCHAR(15) DEFAULT NULL, ADD phone VARCHAR(15) DEFAULT NULL');
    }
